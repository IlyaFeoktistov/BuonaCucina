...
namespace BuonaCucina.TagHelpers.Nav
{
	[HtmlTargetElement(Attributes = "nav-link-active")]
	public class NavLinkActiveTagHelper : TagHelper
	{
        private readonly IHttpContextAccessor _contextAccessor;

        public NavLinkActiveTagHelper(IHttpContextAccessor contextAccessor)
        {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Attributes.RemoveAll("nav-link-active");
        }
